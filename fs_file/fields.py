...
class FSFile(fields.Binary):
    ...
    The field is designed to be used with an additional field of type char
    that stores the filename. This additional field is not mandatory but
    recommended if you want to give the right filename to the created
    attachments and ensure that the mimetype is correctly detected.
    ...
    def __init__(self, storage_code: str = None, field_filename: str = None, **kwargs):
    ...
    def write(self, records, value):
        ...
        #  filesystem storage
        # - we use the field_filename to store the filename in the attachment
        #  and ensure that the mimetype is correctly set if a new attachment is
        #  created
    ...
    def _get_filename(self, record):
        return (
            self.field_filename and getattr(record, self.field_filename) or self._name
        )
