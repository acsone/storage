...
implements the [fsspec.spec.AbstractFileSystem
\<https://filesystem-spec.readthedocs.io/en/
latest/api.html#fsspec.spec.AbstractFileSystem\>](fsspec) interface and
